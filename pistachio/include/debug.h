...
INLINE void NORETURN enter_kdebug(const char *s)
{
    do { } while (true);
}
...
extern "C" void __assert_failure(const char *message);
...
extern struct kdebug_handle_t kdebug_entries;
